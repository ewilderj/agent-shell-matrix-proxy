...
The bot bootstraps cross-signing keys automatically. See [[file:IMPLEMENTATION.md][IMPLEMENTATION.md]]
...
(setq agent-shell-matrix-webhook-host "0.0.0.0")
...
=#agent-{hostname}-{hash}=), invites your whitelisted users, and posts
